...
purchase_data1403to1406_diff=purchase_data1403to1406# purchase_data1403to1406.diff(1)
...
redeem_data1403to1406_diff=redeem_data1403to1406# redeem_data1403to1406.diff(1)
fig = plt.figure(figsize=(12,8))
ax1=fig.add_subplot(211)
...
warnings.filterwarnings("ignore")
redeem_arma_model = sm.tsa.ARMA(redeem_data1403to1406,(7,3)).fit();
purchase_arma_model = sm.tsa.ARMA(purchase_data1403to1406,(8,5)).fit();
...
redeem_predict = redeem_arma_model.predict('2014-07-01', '2014-07-31', dynamic=False);
...
purchase_predict = redeem_arma_model.predict('2014-07-01', '2014-07-31', dynamic=False);
fig, ax = plt.subplots(figsize=(12, 8));
